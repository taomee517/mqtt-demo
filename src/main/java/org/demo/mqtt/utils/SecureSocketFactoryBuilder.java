...
/**
 * SecureSocketFactoryBuilder
 *
 * @Author: taomee
 * @Date: 2020/4/8 0008 14:43
 * @Description:
 */
public class SecureSocketFactoryBuilder {
     ...
     */
    public static SSLSocketFactory getSocketFactory(final String protocolVersion, final String caCertificateFile) throws Exception
    {
        try
        {
    ...
    public static SSLSocketFactory getSocketFactory(final String protocolVersion,
                                                    ...
                                                    final boolean pemFormat) throws Exception
    {
        try
        {
            Security.addProvider(new BouncyCastleProvider());
